                ...
                <div class="header-link">
                    <ul class="header-link-item">
                        ...
                        foreach ($data['menus'] as $menu) {
                            $active = '';
                            if (isset($data['page_active']) && strtolower($data['page_active']) == strtolower($menu['name'])) {
                                $active = 'active_page';
                            }
                            echo '
                            <li ><a class="' . $active . '"  href="' . _WEB_ROOT . '/' . $menu["name"] . '">' . $menu["name"] . '</a></li>
                        ...
                        ?>
                            <a href=" <?php echo _WEB_ROOT . '/user/profile' ?>">
                                ...
                                <img src="<?php
                                            ...
                                            ?>" alt="Avatar" class="img-fluid my-0 mx-[auto] border-2 border-[#98cb50] rounded-full" style="width: 35px;height:35px;" />
                            </a>

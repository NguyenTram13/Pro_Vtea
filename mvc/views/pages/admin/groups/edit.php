<div class="container mx-auto">
    ...
    <h1 class="py-3 text-center text-[3rem]">Sửa nhóm người dùng</h1>
    <?php
    ...
    <form action="" method="post">
        <div class="mb-3 row">
            ...
            <div class="col-sm-12">
                <input type="text" required name="name" class="border-1 w-full outline-[#98cb50] px-2 py-2 rounded" id="name" value="<?php echo $data['grps']['name'] ?>">
            </div>
        </div>

<div class="container mx-auto">
    ...
    <h1 class="text-center py-3 text-[3rem]">Thêm Setting</h1>
    <?php
    ...
    <form action="" method="post">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-12">
                <input type="text" required name="config_value" class="border-1 w-full outline-[#98cb50] px-2 py-2 rounded" id="config_value">
            </div>
        </div>

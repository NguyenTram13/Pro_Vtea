            ...
            <div class="row">
                <div class="col-3">
                    ...
                    <div class="ms-content-left">
                        ...
                        <div data-pathimg="<?php echo _PATH_UPLOAD_PRODUCT ?>" data-url=" <?php echo _WEB_ROOT . '/ajax' ?>" class="px-4 py-2 mt-3 font-semibold text-center transition-all border-2 border-[#98cb50] rounded-lg cursor-pointer filter get-filter bg-slate-50 hover:text-slate-50 hover:bg-[#98cb50] text-[#98cb50]">Filter</div>
                    </div>
                </div>
                <div class="col-9">
                                ...
                                <div class="row product-list g-3">
                                    ...
                                    ?>
                                        <div class="col-xs-12 col-sm-6 col-lg-3 ">
                                            <div class="shadow item new-arrival-item " data-id=" <?php echo $new['id'] ?>">
                                                ...
                                                <div class="arrival-product-content">
                                                    <h3><a class="dot_hidden" href="<?php echo _WEB_ROOT . '/Detail/index/' . $new['id'] ?>"><?php echo $new['name'] ?></a></h3>
                                                    <div class="flex items-center justify-center gap-2 arrival-product-evaluate">
                                                        <span class="rateYoSumpro width-full" data-rateyo-read-only="true" data-rateyo-rating="<?php echo $new['caculate_start']  ?>"></span>
                                                        <span class="sold-out"><?php echo $new['caculate_start']  ?></span>
                                                    </div>
